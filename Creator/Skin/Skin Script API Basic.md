...
| [+ 6.5.2 +] PlayMeta(string): number          | Get play meta values<br>----<br>Supported meta: speed,mod,judge | |
...
| [+ 6.6.22 +]ReadChartCustom(name): string | Get custom value from mc files | |
